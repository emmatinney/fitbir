...
summary(lm(df_fitbir$AD_18_log ~ df_fitbir$ISI_total_score_base + df_fitbir$tbi:df_fitbir$ISI_total_score_base + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

summary(lm(df_fitbir$AD_18_log ~ df_fitbir$ISI_total_score_three + df_fitbir$tbi:df_fitbir$ISI_total_score_three + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex +  df_fitbir$site_numeric))

summary(lm(df_fitbir$AD_18_log ~ df_fitbir$ISI_total_score_six + df_fitbir$tbi:df_fitbir$ISI_total_score_six + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex +  df_fitbir$site_numeric))

summary(lm(df_fitbir$AD_18_log ~ df_fitbir$ISI_total_score_twelve + df_fitbir$tbi:df_fitbir$ISI_total_score_twelve + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex +  df_fitbir$site_numeric))


#interaction between case vs control and ISI left anterior internal cap
summary(lm(df_fitbir$AD_19_log ~ df_fitbir$ISI_total_score_base + df_fitbir$tbi:df_fitbir$ISI_total_score_base + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

summary(lm(df_fitbir$AD_19_log ~ df_fitbir$ISI_total_score_three + df_fitbir$tbi:df_fitbir$ISI_total_score_three + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

summary(lm(df_fitbir$AD_19_log ~ df_fitbir$ISI_total_score_six + df_fitbir$tbi:df_fitbir$ISI_total_score_six + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

summary(lm(df_fitbir$AD_19_log ~ df_fitbir$ISI_total_score_twelve + df_fitbir$tbi:df_fitbir$ISI_total_score_twelve + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

#interaction between case vs control and ISI right posterior internal cap
summary(lm(df_fitbir$AD_20_log ~ df_fitbir$ISI_total_score_base + df_fitbir$tbi:df_fitbir$ISI_total_score_base + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

summary(lm(df_fitbir$AD_20_log ~ df_fitbir$ISI_total_score_three + df_fitbir$tbi:df_fitbir$ISI_total_score_three + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

summary(lm(df_fitbir$AD_20_log ~ df_fitbir$ISI_total_score_six + df_fitbir$tbi:df_fitbir$ISI_total_score_six + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

summary(lm(df_fitbir$AD_20_log ~ df_fitbir$ISI_total_score_twelve + df_fitbir$tbi:df_fitbir$ISI_total_score_twelve + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

#interaction between case vs control and ISI left posterior internal cap
summary(lm(df_fitbir$AD_21_log ~ df_fitbir$ISI_total_score_base + df_fitbir$tbi:df_fitbir$ISI_total_score_base + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

summary(lm(df_fitbir$AD_21_log ~ df_fitbir$ISI_total_score_three + df_fitbir$tbi:df_fitbir$ISI_total_score_three + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

summary(lm(df_fitbir$AD_21_log ~ df_fitbir$ISI_total_score_six + df_fitbir$tbi:df_fitbir$ISI_total_score_six + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

summary(lm(df_fitbir$AD_21_log ~ df_fitbir$ISI_total_score_twelve + df_fitbir$tbi:df_fitbir$ISI_total_score_twelve + df_fitbir$tbi + df_fitbir$SES + df_fitbir$educ + df_fitbir$age + df_fitbir$sex))

#correlation between CASES AD AIC_L and ISI
summary(lm(case$AD_19_log ~ case$ISI_total_score_base + case$SES + case$educ + case$age + case$sex  +  case$site_numeric))
summary(lm(case$AD_19_log ~ case$ISI_total_score_three + case$SES + case$educ + case$age + case$sex  +  case$site_numeric))
summary(lm(case$AD_19_log ~ case$ISI_total_score_six + case$SES + case$educ + case$age + case$sex  +  case$site_numeric))
summary(lm(case$AD_19_log ~ case$ISI_total_score_twelve + case$SES + case$educ + case$age + case$sex  +  case$site_numeric))
...
library(ggplot2)
ggplot(df_fitbir, aes(x = AD_19_log, y = ISI_base_log)) + 
...
df_fitbir$ISI_base_log <- as.numeric(df_fitbir$ISI_base_log)

model <- lm(AD_19_log ~ ISI_base + tbi:ISI_base + tbi + SES + educ + age + sex, data = df_fitbir)

model3 <- lm(AD_19_log ~ ISI_3_log + tbi:ISI_3_log + tbi + SES + educ + age + sex, data = df_fitbir)

model6 <- lm(AD_19_log ~ ISI_6_log + tbi:ISI_6_log + tbi + SES + educ + age + sex, data = df_fitbir)

model12 <- lm(AD_19_log ~ ISI_12_log + tbi:ISI_12_log + tbi + SES + educ + age + sex, data = df_fitbir)
...
diagnostics(df_fitbir$AD_19_log, df_fitbir$ISI_total_score_base)

diagnostics(df_fitbir$AD_19_log, df_fitbir$ISI_total_score_three)

diagnostics(df_fitbir$AD_19_log, df_fitbir$ISI_total_score_six)

diagnostics(df_fitbir$AD_19_log, df_fitbir$ISI_total_score_twelve)
#right anterior internal cap
diagnostics(df_fitbir$AD_18_log, df_fitbir$ISI_total_score_base)

diagnostics(df_fitbir$AD_18_log, df_fitbir$ISI_total_score_three)

diagnostics(df_fitbir$AD_18_log, df_fitbir$ISI_total_score_six)

diagnostics(df_fitbir$AD_18_log, df_fitbir$ISI_total_score_twelve)
#left posterior internal cap
diagnostics(df_fitbir$AD_21_log, df_fitbir$ISI_total_score_base)

diagnostics(df_fitbir$AD_21_log, df_fitbir$ISI_total_score_three)

diagnostics(df_fitbir$AD_21_log, df_fitbir$ISI_total_score_six)

diagnostics(df_fitbir$AD_21_log, df_fitbir$ISI_total_score_twelve)
#right posterior internal cap
diagnostics(df_fitbir$AD_20_log, df_fitbir$ISI_total_score_base)

diagnostics(df_fitbir$AD_20_log, df_fitbir$ISI_total_score_three)

diagnostics(df_fitbir$AD_20_log, df_fitbir$ISI_total_score_six)

diagnostics(df_fitbir$AD_20_log, df_fitbir$ISI_total_score_twelve)
...
model <- lm(ISI_total_score_base ~ AD_19_log + tbi:AD_19_log + tbi + SES + educ + age + sex, data = df_fitbir)
summ(model)
model3 <- lm(ISI_total_score_three ~  AD_19_log + tbi:AD_19_log + tbi + SES + educ + age + sex, data = df_fitbir)
summ(model3)

model6 <- lm(ISI_total_score_six ~ AD_19_log  + tbi:AD_19_log + tbi + SES + educ + age + sex, data = df_fitbir)
summ(model6)

model12 <- lm(AD_19_log ~ ISI_total_score_twelve + tbi:ISI_total_score_twelve + tbi + SES + educ + age + sex, data = df_fitbir)
summ(model12)

interact_plot(model, pred = AD_19_log, modx = tbi, partial.residuals = TRUE, interval = TRUE)  + theme_apa()

interact_plot(model3, pred = AD_19_log, modx = tbi, partial.residuals = TRUE, interval = TRUE)  + theme_apa()

interact_plot(model6, pred = AD_19_log, modx = tbi, partial.residuals = TRUE, interval = TRUE)  + theme_apa()
...
ss <- sim_slopes(model, pred = AD_19_log, modx = tbi, johnson_neyman = FALSE, control.fdr = TRUE)
ss
plot(ss)  + theme_apa()
as_huxtable(ss)

ss3 <- sim_slopes(model3, pred = AD_19_log, modx = tbi, johnson_neyman = FALSE, control.fdr = TRUE)
ss3
plot(ss3) + theme_apa()
as_huxtable(ss3)

ss6 <- sim_slopes(model6, pred = AD_19_log, modx = tbi, johnson_neyman = FALSE, control.fdr = TRUE)
ss6
as_huxtable(ss6)
