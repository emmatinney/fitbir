...
fitRandomInterceptSlope <- lme(RAVLTlearntall ~ AD_19*timepoint + AD_19*age_category +  AD_19*timepoint*age_category + SES + age + educ + sex,random=~1|id, data=na.omit(dft))
summary(fitRandomInterceptSlope)
