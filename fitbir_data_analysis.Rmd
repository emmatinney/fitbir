...
long_track_tbi <- read_excel("~/Documents/Northeastern/CCBH_Lab/Projects/fitbir/track_tbi.xlsx",  
+     sheet = "long")
...
summary(lm(RAVLTlearntall ~ AD_18 + timepointl + ISI_al:AD_18 + timepoint:ISI_all + ISI_all:AD_18 + timepoint:AD_18:ISI_all + SES + educ + age + sex, data=case))
